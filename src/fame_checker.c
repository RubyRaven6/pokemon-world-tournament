...
//     [FAMECHECKER_BROCK]    = TRAINER_LEADER_BROCK_FRLG,
//     [FAMECHECKER_MISTY]    = TRAINER_LEADER_MISTY_FRLG,
//     [FAMECHECKER_LTSURGE]  = TRAINER_LEADER_LT_SURGE_FRLG,
//     [FAMECHECKER_ERIKA]    = TRAINER_LEADER_ERIKA_FRLG,
//     [FAMECHECKER_KOGA]     = TRAINER_LEADER_KOGA,
//     [FAMECHECKER_SABRINA]  = TRAINER_LEADER_SABRINA_FRLG,
//     [FAMECHECKER_BLAINE]   = TRAINER_LEADER_BLAINE_FRLG,
...
// {
//     if (HasTrainerBeenFought(TRAINER_LEADER_GIOVANNI_FRLG) == TRUE)
//     {
//         if (a0 == 9)
